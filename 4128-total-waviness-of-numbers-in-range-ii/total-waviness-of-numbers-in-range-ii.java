class Solution {
    public String s;
    public Map<String,long[]> mp=new HashMap<>();

    public long[] dfs(int i,int a,int b,int t,int st,int len){
        ...
        for(int d=0;d<=limit;d++){
            long[] res=dfs(i+1,b,d,t==1 && d==(s.charAt(i)-'0') ? 1:0,(st==1||d>0)?1:0,(st==1||d>0)?len+1:0);
